        ...
        <figure className="grid items-center grid-cols-1 gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <svg
              ...
              fill="none"
              aria-hidden="true"
              className="absolute left-0 h-32 -top-12 -z-10 stroke-gray-100/30"
            >
              <path
            ...
            <blockquote className="text-xl font-semibold leading-8 text-center text-white lg:text-left sm:text-xl sm:leading-9">
              <p>
                {story}
              </p>
            </blockquote>
          </div>
          <div className="mx-auto lg:col-end-1 w-80 lg:row-span-4 lg:w-80">
            <img
